            ...
            <div class="col-lg-4">
                <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <div class="ps-4">
                        ...
                        <h3 class="text-primary mb-0">+91 7252933077</h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.4s">
                    ...
                    <div class="ps-4">
                        ...
                        <p class="text-primary mb-0">info@skywalkerintelligence.com</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.8s">
                    ...
                    <div class="ps-4">
                        ...
                        <h6 class="text-primary mb-0">Agra, Uttar Pradesh 282001</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container py-5 mb-5">
        <div class="bg-white">
            <div class="owl-carousel vendor-carousel">
                <img src="{{ asset('web/img/vendor-1.jpg') }}" alt="Vendor 1">
                <img src="{{ asset('web/img/vendor-2.jpg') }}" alt="Vendor 2">
                <img src="{{ asset('web/img/vendor-3.jpg') }}" alt="Vendor 3">
                <img src="{{ asset('web/img/vendor-4.jpg') }}" alt="Vendor 4">
                <img src="{{ asset('web/img/vendor-5.jpg') }}" alt="Vendor 5">
                <img src="{{ asset('web/img/vendor-6.jpg') }}" alt="Vendor 6">
                <img src="{{ asset('web/img/vendor-7.jpg') }}" alt="Vendor 7">
                <img src="{{ asset('web/img/vendor-8.jpg') }}" alt="Vendor 8">
                <img src="{{ asset('web/img/vendor-9.jpg') }}" alt="Vendor 9">
            </div>
        </div>
    </div>
</div>
